...
class SatSettingForm extends Component {
   ...
   showSatellite = e => {
       // e is to prevent the form to do its own default action, like submit
       // e.stopprobagation is to stop the bubble process
       e.preventDefault();
...
// SatSetting1 is a component.
// SatSetting is the configuration of our form, and satSetting1 is the actual form created.
